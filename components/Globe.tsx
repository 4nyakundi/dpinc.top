...
export function OriginkitGlobe({
    speed = 2,
    smoothing = 8,
    dots = { color: "#06b6d4", size: 5, density: 8, allDots: false },
    fill = "dots",
    fillColor = "#ffffff",
    scale = 8,
    stopOnHover = false,
    ...
    initialLatitude = 10,
    initialLongitude = 35,
    oceanColor = "rgba(5,5,10,0.6)",
    outlineColor = "#06b6d4",
    showOutline = true,
    graticuleColor = "rgba(168,85,247,0.25)",
    showGrid = true,
    outlineWidth = 1,
    dragSpeed = 5,
    detail = 5,
    ...
    if (error) {
        return (
            <div style={containerStyle} className={className}>
                <div style={{ color: "#ffffff", textAlign: "center", padding: "16px" }}>
                    <div>Error loading Earth visualization</div>
                </div>
            </div>
        );
    }
...
export default function Globe(props: Record<string, unknown>) {
    return (
        <div className="fixed top-1/2 right-0 -translate-y-1/2 w-[700px] h-[700px] pointer-events-auto z-[1] opacity-85 hidden lg:block">
            <OriginkitGlobe
                speed={2}
                scale={10}
                initialLatitude={10}
                ...
                dots={{ color: "#06b6d4", size: 5, density: 8, allDots: false }}
                outlineColor="#06b6d4"
                graticuleColor="rgba(168,85,247,0.2)"
                oceanColor="rgba(5,5,10,0.5)"
                {...props}
            />
        </div>
    );
